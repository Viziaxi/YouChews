...
const RecommendationPageTest: React.FC = () => {
  // State Management
  ...
  return (
    <div className="min-h-screen bg-yellow-100 flex flex-col items-center justify-center p-4">
      ...
      {/*<div className="mb-4 text-xs text-gray-400">
        Considering 10 places within 50 km
      </div>*/}
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-t-[#ef4444]">
        ...
        {/* You could put a dynamic Google Map image here using the lat/lon */}
        ...
        <div className="p-6">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">McDonald's</h1>
              <p className="text-sm text-gray-500 mt-1">1451 Coleman Ave</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm mb-6">
            <div>
              ...
              <p className="font-medium text-gray-700">Burger, Fries, Shake</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium text-gray-700">1 mi ( 1.6 km)</p>
            </div>
            <div>
...
export default RecommendationPageTest;
